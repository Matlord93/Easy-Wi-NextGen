...
rg -q 'download_panel_source_archive' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'list_panel_checksum_assets' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'github_json_asset_names' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'github_json_first_tag_name' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'resolve_panel_release_tag_from_html' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'list_panel_release_assets_from_html' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -Fq '/releases/expanded_assets/${tag}' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'keine Assets per GitHub-API, Release-Seite oder Checksum-Dateien ermittelbar' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'command -v jq >/dev/null 2>&1; then' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -Fq "grep -E '^(easywi-|checksums-|checksums\.|manifest\.json$)'" "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'checksums-webinterface.txt checksums-core.txt checksums.txt checksums.sha256' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'GitHub-API nicht verfügbar; aus Checksums' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -Fq 'archive/refs/tags/${tag}.tar.gz' "$repo_root/installer/easywi-installer-menu-linux.sh"
rg -q 'Kein passendes Release-Asset gefunden.*GitHub-Quellarchiv' "$repo_root/installer/easywi-installer-menu-linux.sh"
