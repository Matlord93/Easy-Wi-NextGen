...
PHP_SCRIPT;
    ...
    private function newService(string $appRoot, CapturingLogger $logger, int $keepReleases = 2): WebinterfaceUpdateService
    {
        return new WebinterfaceUpdateService(
            ...
            settingsService: new WebinterfaceUpdateSettingsService($appRoot . '/settings'),
            manifestUrl: 'https://example.invalid/manifest.json',
            installDir: $appRoot,
            releasesDir: $appRoot . '/releases',
            currentSymlink: $appRoot . '/current',
            lockFile: $appRoot . '/var/update.lock',
            excludes: '',
            ...
            panelUpdateNewsPublisher: null,
            coreReleaseChecker: null,
            githubToken: null,
            logger: $logger,
        );
    }
