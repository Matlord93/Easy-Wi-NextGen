...
final class Version20250311123000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE port_pools (id INT AUTO_INCREMENT NOT NULL, node_id VARCHAR(64) NOT NULL, name VARCHAR(120) NOT NULL, tag VARCHAR(120) NOT NULL DEFAULT \'\', enabled TINYINT(1) NOT NULL DEFAULT 1, start_port INT NOT NULL, end_port INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX idx_port_pools_node_id (node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
