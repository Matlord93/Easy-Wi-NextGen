...
final class Version20270301091000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!$schema->hasTable('blog_post_tags')) {
            $this->addSql('CREATE TABLE blog_post_tags (post_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_3971B624B89032C (post_id), INDEX IDX_3971B62BAD26311 (tag_id), PRIMARY KEY(post_id, tag_id)) DEFAULT CHARACTER SET utf8mb4');
        }
