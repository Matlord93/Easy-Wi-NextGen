    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isSqlite) {
            $this->addSql('CREATE TABLE musicbot_autodj_settings (
                ...
                mode VARCHAR(30) NOT NULL DEFAULT \'random\',
                avoid_repeats BOOLEAN NOT NULL DEFAULT 1,
                min_queue_size INTEGER NOT NULL DEFAULT 2,
            ...
            $this->addSql('CREATE TABLE musicbot_autodj_settings (
                ...
                mode VARCHAR(30) NOT NULL DEFAULT \'random\',
                avoid_repeats TINYINT(1) NOT NULL DEFAULT 1,
                min_queue_size INT NOT NULL DEFAULT 2,
                genre_filter VARCHAR(120) DEFAULT NULL,
