...
final class AdminSearchController
{
    ...
    {
        return array_map(static function (\App\Module\Core\Domain\Entity\Instance $instance): array {
            return [
                'id' => $instance->getId(),
    ...
    {
        return array_map(static function (\App\Module\Core\Domain\Entity\Domain $domain): array {
            return [
                'id' => $domain->getId(),
                'name' => $domain->getName(),
    ...
    {
        return array_map(static function (\App\Module\Core\Domain\Entity\Ticket $ticket): array {
            return [
                'id' => $ticket->getId(),
