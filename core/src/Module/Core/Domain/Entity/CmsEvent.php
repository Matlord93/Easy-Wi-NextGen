...
class CmsEvent
{
    ...
    {
        $this->location = $location === null ? null : trim($location);
        $this->touch();
    }
    ...
    {
        $this->status = trim($status) !== '' ? trim($status) : 'planned';
        $this->touch();
    }
    ...
    {
        $this->coverImagePath = $coverImagePath === null ? null : trim($coverImagePath);
        $this->touch();
    }
