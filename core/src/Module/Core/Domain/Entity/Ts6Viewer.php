...
#[ORM\Entity(repositoryClass: Ts6ViewerRepository::class)]
#[ORM\Table(name: 'ts6_viewers')]
class Ts6Viewer
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function __construct(Ts6VirtualServer $virtualServer, string $publicId)
    {
