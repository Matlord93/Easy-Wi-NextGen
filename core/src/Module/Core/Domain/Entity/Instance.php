...
class Instance implements ResourceEventSource
{
    ...
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $startScriptPath = null;
    ...
    public function setSteamAccount(?string $steamAccount): void
    {
        $this->steamAccount = $steamAccount;
        $this->touch();
    }

    public function getGslKey(): ?string
    {
        return $this->gslKey;
    }

    public function setGslKey(?string $gslKey): void
    {
        $this->gslKey = $gslKey;
        $this->touch();
    }
    ...
    public function getStartScriptPath(): ?string
    {
        return $this->startScriptPath;
    }

    public function setStartScriptPath(?string $startScriptPath): void
    {
