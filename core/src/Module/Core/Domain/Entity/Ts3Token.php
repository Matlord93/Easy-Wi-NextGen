...
class Ts3Token
{
    ...
    #[ORM\ManyToOne(targetEntity: Ts3VirtualServer::class)]
    ...
    public function __construct(Ts3VirtualServer $virtualServer, string $tokenEncrypted, string $type)
    {
