...
{
    public const DEFAULT_DOWNLOAD_URL = 'https://github.com/teamspeak/teamspeak6-server/releases/download/v6.0.0/beta8/teamspeak-server_linux_amd64-v6.0.0-beta8.tar.bz2';
