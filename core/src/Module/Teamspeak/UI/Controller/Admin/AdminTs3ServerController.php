...
final class AdminTs3ServerController
{
    ...
    #[Route(path: '', name: 'admin_ts3_servers_index', methods: ['GET'])]
    ...
    #[Route(path: '/create', name: 'admin_ts3_servers_create', methods: ['GET', 'POST'])]
    public function create(Request $request): Response
    {
        ...
        $form = $this->formFactory->create(Ts3AdminCreateVirtualServerType::class, $dto, [
    ...
    #[Route(path: '/{id}/assign', name: 'admin_ts3_servers_assign', methods: ['POST'])]
    public function assign(Request $request, int $id): Response
    {
        ...
        $this->validateCsrf($request, 'ts3_virtual_assign_' . $id);
