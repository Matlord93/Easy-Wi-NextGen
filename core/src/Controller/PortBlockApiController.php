...
final class PortBlockApiController
{
    ...
    #[Route(path: '/port-blocks', name: 'port_blocks_list', methods: ['GET'])]
    ...
    #[Route(path: '/admin/port-blocks', name: 'admin_port_blocks_create', methods: ['POST'])]
    public function create(Request $request): JsonResponse
    {
        ...
        return new JsonResponse([
            'port_block' => $this->normalizeBlock($block),
